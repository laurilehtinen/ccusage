...
mod smoke_tests {
    ...
    #[test]
    #[ignore = "requires real Cursor home with store.db or sdk-agent-store"]
    fn smoke_real_cursor_home_loads_without_error() {
...
mod tests {
    ...
    fn summary(cache_creation_tokens: u64) -> UsageSummary {
        UsageSummary {
            ...
            credits: None,
            message_count: None,
            models_used: vec!["cursor-grok-4.6-high-fast".to_string()],
